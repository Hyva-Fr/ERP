...
__webpack_require__(/*! ./session */ "./resources/js/session.js");

__webpack_require__(/*! ./includes/index */ "./resources/js/includes/index.js");

__webpack_require__(/*! ./forms/index */ "./resources/js/forms/index.js");

__webpack_require__(/*! ./pages/index */ "./resources/js/pages/index.js");

__webpack_require__(/*! ./modals/index */ "./resources/js/modals/index.js");
...
var formHidden = '[name="form"]';
var addBtns = '.new-block';
var removeBtns = '.remove-block';
var buildBlock = '.build-block';
var buildBlockSpecial = '.build-block.special';
var editBlock = '.edit-block';
var lastBlock = '#last-block';
var headerType = '[name="header-format"]:checked';
var contentType = '[name="content-format"]:checked';
var footerType = '[name="footer-format"]:checked';
var closeFormEdit = '.close-form-edit';
var allBlocks = '.build-block:not(#last-block)';
var formEditor = '#form-editor';
var buildSpecials = '.build-block.special';
var refsEditor = '#refs-editor';
var dataStart = '.build-block.special[data-type="start"]';
var dataEnd = '.build-block.special[data-type="end"]';
var start = {
  type: "constructor"
};
var end = {
...
var radiosBtns = '.form-builder .with-font';
var saveBtn = '#saveContent';
var submitBtn = '.form-submit';
var formForm = '.form-crud';
var addOpt = '#add-opt';
var urls = {
...
var form = document.querySelector(formHidden) ? JSON.parse(document.querySelector(formHidden).value) : null;
...
function onSubmitForm() {
  $(submitBtn).on('click', function (e) {
    e.preventDefault();
    var form = $(this).closest(formForm),
        blocks = $(buildBlock),
        submit = false;
    ...
    if (submit === false) {
      var message = $(refsEditor).data('endform');
...
function setForm() {
  ...
  if (init === false) {
    ...
    var _blocks = $(buildBlock);

    var content = [];

    for (var i = 0; i < _blocks.length; i++) {
      if (_blocks[i].dataset.info) {
        content.push(_blocks[i].dataset.info);
      }
    }
...
function setFormFromData() {
  if (form && document.querySelector('.form-edit-crud')) {
    ...
    for (var _i = 0; _i < replacer.length; _i++) {
      var newBlock = replacer[_i];
      ...
      var pen = newBlock.data !== 'end' ? '<i class="fa-solid fa-pen-to-square fa-lg fa-fw edit-block" data-json=\'' + JSON.stringify(newBlock) + '\'></i>' : '';
      ...
      var html = '<div><p class="block-title">' + newBlock.title + pen + '</p><small>' + newBlock.small + '</small></div><i class="fa-solid fa-circle-minus fa-lg fa-fw remove-block"></i>';
      div.innerHTML = html;
      var container = document.querySelector(formEditor),
...
function setBlockTransfert() {
  $(addBtns).on('click', function () {
    ...
    if (data === 'start' || data === 'end') {
      var message = checkConstructionContainers(data);
    ...
    var pen = data !== 'end' ? '<i class="fa-solid fa-pen-to-square fa-lg fa-fw edit-block" data-json=\'' + JSON.stringify(newBlock) + '\'></i>' : '';
    var div = document.createElement('div');
    div.setAttribute('class', classes);
    ...
    div.dataset.info = JSON.stringify(newBlock);
    div.setAttribute('style', 'background-color: ' + newBlock.color + ';');
    var html = '<div><p class="block-title">' + newBlock.label + pen + '</p><small>' + newBlock.small + '</small></div><i class="fa-solid fa-circle-minus fa-lg fa-fw remove-block"></i>';
    div.innerHTML = html;
    var container = document.querySelector(formEditor),
        lastElement = document.querySelector(lastBlock);
    container.insertBefore(div, lastElement);
...
function checkConstructionContainers(data) {
  var blocks = $(buildSpecials);

  if (blocks.length > 0) {
    var last = $(blocks[blocks.length - 1]);

    if (last) {
      var type = last.data('type'),
...
function setNewBlocksListeners(div) {
  $(div).find(removeBtns).on('click', function () {
    ...
    if (type === 'end') {
      ...
      if (previous && previous.dataset.type === 'end') {
        ...
        var _next = getNextSibling(div, buildBlock);
  ...
  $(div).find(editBlock).on('click', function () {
    ...
    var persist = JSON.parse(this.dataset.json);
    var parent = this.closest('.build-block');
    var div = document.createElement('div');
    ...
    $(addOpt).on('click', function () {
      var opts = this.parentElement.querySelectorAll('.opts');

      for (var i = 0; i < opts.length; i++) {
        var minus = opts[i].querySelector('.remove-opt');
    ...
    $(saveBtn).on('click', function () {
      var inputs = this.closest('.modal-full').querySelectorAll('.get-data');
      var options = [];
...
function removeOptions(elmt) {
  var lab = elmt.closest('label');
  var parent = elmt.closest('.modal-full');
  lab.parentElement.removeChild(lab);
  var os = parent.querySelectorAll('.opts');
...
function setRadioBtns() {
  ...
  var _loop = function _loop(i) {
    ...
    $(btn).on('input', function () {
      setForm();
      $(bg).css({
        'background-image': 'url("' + urls[id] + this.value + '.jpg")'
      });
    });
  };
...
/***/ "./resources/js/includes/aside.js":
/*!****************************************!*\
  !*** ./resources/js/includes/aside.js ***!
  \****************************************/
/***/ (() => {

var asideListContainer = '#aside-list-container';
var asideLists = '.aside-list';
var dropdowns = '.dropdown';
var selectedDropdowns = '.dropdown.show';
var triggers = '.aside-list > span';
var angle = '.fa-angle-down';
var aside = 'aside';
$(document).ready(function () {
  setDropdownMaxHeight();
  $(triggers).on('click', function () {
    var dropdown = $(this).closest(asideLists).children(dropdowns),
        height = 0,
...
function setDropdownMaxHeight() {
  var dropdowns = $(selectedDropdowns);
...
/***/ "./resources/js/includes/footer.js":
/*!*****************************************!*\
  !*** ./resources/js/includes/footer.js ***!
  \*****************************************/
/***/ (() => {
...
/***/ "./resources/js/includes/header.js":
/*!*****************************************!*\
  !*** ./resources/js/includes/header.js ***!
  \*****************************************/
/***/ (() => {
...
/***/ "./resources/js/includes/index.js":
/*!****************************************!*\
  !*** ./resources/js/includes/index.js ***!
  \****************************************/
/***/ ((__unused_webpack_module, __unused_webpack_exports, __webpack_require__) => {

__webpack_require__(/*! ./header */ "./resources/js/includes/header.js");

__webpack_require__(/*! ./aside */ "./resources/js/includes/aside.js");

__webpack_require__(/*! ./footer */ "./resources/js/includes/footer.js");
...
/***/ "./resources/js/pages/crud.js":
/*!************************************!*\
  !*** ./resources/js/pages/crud.js ***!
  \************************************/
/***/ (() => {

var filtersFormBtn = '.crud-filters button[type="submit"]';
var paginationLinks = '.pagination-links > a';
var URL = location.pathname;
var tableContainer = '.crud-table-container';
var htmlReplacerCrud = '#crud-ajax';
var crudLoader = '#crud-loader';
var saveBtn = '.form-crud button[type="submit"]';
var required = '.form-crud :required';
var grants = '[name="constants[]"]';
var loader = '#loader';
var formCrud = '.form-crud';
$(document).ready(function () {
  setListenersCrud();
  setTinyMCE('#email-content'); //setFormControl();
...
function setListenersCrud() {
  ...
  $(paginationLinks).on('click', function (e) {
    e.preventDefault();
    var pageNb = this.href.split('?page=')[1];
    var radios = $('[name="crud-order"]'),
        check = 'asc';
...
/***/ "./resources/js/pages/edit-show.js":
/*!*****************************************!*\
  !*** ./resources/js/pages/edit-show.js ***!
  \*****************************************/
/***/ (() => {

var fileLabels = '.file-form';
var picContainer = '.pics-container';
var fileInput = '.file-form input[type="file"]';
var fileTitle = '.file-title';
var fileBtn = '.file-form button[type="button"]';
var acceptPdf = 'application/pdf';
var acceptXls = 'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet, application/vnd.ms-excel';
var multiTrigger = '#new-images-container button[type="button"]';
var multiInput = '#files-trigger';
var filesList = '#new-files-lister';
var deleteImage = '.delete-image-mission';
var deleteURL = '/ajax/delete-mission-image';
var loader = '#loader';
$(document).ready(function () {
...
function setFileName(elmt) {
  ...
  if (accept === acceptPdf && ext === 'pdf' || accept === acceptXls && (ext === 'xls' || ext === 'xlsx')) {
...
__webpack_require__(/*! ./dashboard */ "./resources/js/pages/dashboard.js");

__webpack_require__(/*! ./crud */ "./resources/js/pages/crud.js");

__webpack_require__(/*! ./profile */ "./resources/js/pages/profile.js");

__webpack_require__(/*! ./edit-show */ "./resources/js/pages/edit-show.js");
...
var picTrigger = '#pic-trigger';
var inputFile = '#file-trigger';
var filePreview = '#profile-avatar-preview';
var input = '#user-avatar';
var deleteAvatar = '#delete-avatar';
var submits = '.profile-container button[type="submit"]';
var loader = '#loader';
$(document).ready(function () {
  setEvents();
});
...
function replaceByDefault() {
  var data = $(deleteAvatar).data('url');
  $(input).val('');
  $(filePreview).css({
...
function ajaxSubmit(elmt) {
  ...
  $.ajax({
    ...
    error: function error(_error) {
      ...
      if (isJson(_error.responseText)) {
        _error = JSON.parse(_error.responseText);
        var errosContainer = $('[action="' + action + '"] .errors-container');
        var html = '<p class="partials error">' + _error.message + '</p>';
        html += '<ul class="partials errors-list">';

        for (var key in _error.errors) {
          html += '<li class="error">' + key.replaceAll('_', ' ') + ':<ul>';
          var errs = _error.errors[key];
...
function checkAuth() {
  axios__WEBPACK_IMPORTED_MODULE_0___default().post("".concat(window.sessionout.authpingEndpoint), {
    pinguser: 1
    ...
    if (parseInt(response.data.auth) === 0) {
      ...
      if (!document.querySelector("#modal-quantic").classList.contains('modal-quantic-show')) {
        ...
        document.querySelector("#progress-bar").innerHTML = '<span class="fill-loader-bar"></span>';
      } else {
        ...
        if (parseInt(Date.now()) >= window.sessionout.stamp + 49990) {
          document.querySelector("#progress-bar span").classList.remove('fill-loader-bar');
          setTimeout(function () {
...
(function () {
  if (document.querySelector("#modal-quantic")) {
    ...
    if (parseInt(window.sessionout.usingBroadcasting) === 1) {
      ...
      Echo["private"]("user.session-track.".concat(window.sessionout.userId)).listen('.session.active', function (e) {
...
/***/ "./resources/css/dimmers/index.css":
/*!*****************************************!*\
  !*** ./resources/css/dimmers/index.css ***!
  \*****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./resources/css/widgets/index.css":
/*!*****************************************!*\
  !*** ./resources/css/widgets/index.css ***!
  \*****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/******/ 	__webpack_require__.O(undefined, ["css/app","css/dimmers","css/widgets"], () => (__webpack_require__("./resources/js/app.js")))
/******/ 	__webpack_require__.O(undefined, ["css/app","css/dimmers","css/widgets"], () => (__webpack_require__("./resources/css/app.css")))
/******/ 	__webpack_require__.O(undefined, ["css/app","css/dimmers","css/widgets"], () => (__webpack_require__("./resources/css/dimmers/index.css")))
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["css/app","css/dimmers","css/widgets"], () => (__webpack_require__("./resources/css/widgets/index.css")))
